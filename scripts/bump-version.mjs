...
console.log(`   4) אחרי שהגרסה זמינה בחנויות — לקבוע ב-Firebase RTDB:`)
console.log(`      AppConfig/vantix_version = "${version}"`)
console.log(`      (אופציונלי: vantix_version_android / vantix_version_ios)\n`)
